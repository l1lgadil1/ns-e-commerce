...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between md:p-24">
      ...
      <div className="mb-32 grid text-center  lg:mb-0 w-full lg:max-w-5xl lg:grid-cols-3 lg:text-left px-4">
        <MenuCard href='/' title='Наш сайт -&gt;' />
        <MenuCard href='/' title='Instagram' iconSrc='/images/instagram.svg' />
        <MenuCard href='/' title='Kaspi магазин' description='Наши товары в Kaspi магазине' iconSrc='/images/kaspi-logo.png' />
      </div>
    </main>
  );
}
